...
namespace MetricsManagerTests
{
	public class RamControllerUnitTests
	{
		...
		public void GetMetricsFromAgent_ReturnsCorrectMetrics()
		{
			...
			var mockMetrics = new AllRamMetrics();
		...
		public void GetMetricsFromAllCluster_ReturnsCorrectMetrics()
		{
			...
			var mockMetricsForAgent_1 = new AllRamMetrics();
			...
			var mockMetricsForAgent_2 = new AllRamMetrics();
		...
		private bool CompareMetricsContainers(IActionResult result, AllRamMetrics mockMetrics)
		{
			var responseMetrics = ((result as OkObjectResult).Value as AllRamMetricsResponse);
