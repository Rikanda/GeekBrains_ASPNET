...
namespace MetricsManagerTests
{
	public class CpuControllerUnitTests
	{
		...
		public void GetMetricsFromAllCluster_ReturnsCorrectMetrics()
		{
			...
			var mockMetricsForAgent_1 = new AllCpuMetrics();
			...
			var mockMetricsForAgent_2 = new AllCpuMetrics();
		...
		private bool CompareMetricsContainers(IActionResult result, AllCpuMetrics mockMetrics)
		{
			var responseMetrics = ((result as OkObjectResult).Value as AllCpuMetricsResponse);
